...
var Popover = (props) => {
  ...
  const [hasCustomAnchor, setHasCustomAnchor] = React32.useState(false);
  ...
  return (0, import_jsx_runtime20.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime20.jsx)(
    PopoverProvider,
    {
      ...
      hasCustomAnchor,
      onCustomAnchorAdd: React32.useCallback(() => setHasCustomAnchor(true), []),
      onCustomAnchorRemove: React32.useCallback(() => setHasCustomAnchor(false), []),
      modal,
      children
    }
  ) });
...
var PopoverAnchor = React32.forwardRef(
  (props, forwardedRef) => {
...
var PopoverTrigger = React32.forwardRef(
  (props, forwardedRef) => {
...
var PopoverPortal = (props) => {
  ...
  return (0, import_jsx_runtime20.jsx)(PortalProvider, { scope: __scopePopover, forceMount, children: (0, import_jsx_runtime20.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime20.jsx)(Portal, { asChild: true, container, children }) }) });
};
...
var Slot7 = createSlot6("PopoverContent.RemoveScroll");
var PopoverContentModal = React32.forwardRef(
  (props, forwardedRef) => {
    const context = usePopoverContext(CONTENT_NAME2, props.__scopePopover);
    const contentRef = React32.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, contentRef);
    const isRightClickOutsideRef = React32.useRef(false);
    React32.useEffect(() => {
      const content = contentRef.current;
      if (content) return hideOthers(content);
    }, []);
    return (0, import_jsx_runtime20.jsx)(Combination_default, { as: Slot7, allowPinchZoom: true, children: (0, import_jsx_runtime20.jsx)(
      PopoverContentImpl,
      {
        ...props,
        ref: composedRefs,
...
var PopoverContentNonModal = React32.forwardRef(
  (props, forwardedRef) => {
    const context = usePopoverContext(CONTENT_NAME2, props.__scopePopover);
...
var PopoverContentImpl = React32.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopePopover,
      trapFocus,
...
var PopoverClose = React32.forwardRef(
  (props, forwardedRef) => {
...
var PopoverArrow = React32.forwardRef(
  (props, forwardedRef) => {
